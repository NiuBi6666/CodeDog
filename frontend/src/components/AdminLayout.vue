...
import { ClipboardCheck, ExternalLink, FileSpreadsheet, FileText, Home, ListChecks, Menu, ScrollText, Search, ShieldCheck, Trophy } from "@lucide/vue";
  ...
  <div class="admin-app" :class="{ 'sidebar-open': sidebarOpen }" data-admin-shell>
    <aside class="admin-sidebar" aria-label="后台导航">
      ...
      <nav class="admin-nav">
        ...
        <RouterLink v-if="auth.user?.admin" :class="{ active: activePage === 'exams' }" to="/exams"><FileSpreadsheet class="nav-icon" :size="17"/><span>成绩管理</span></RouterLink>
